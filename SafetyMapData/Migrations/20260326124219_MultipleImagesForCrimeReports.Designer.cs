...
namespace SafetyMapData.Migrations
{
    ...
    [Migration("20260326124219_MultipleImagesForCrimeReports")]
    partial class MultipleImagesForCrimeReports
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SafetyMapData.Entities.UserCrimeReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("UserCrimeReports");
                });

            modelBuilder.Entity("SafetyMapData.Entities.UserCrimeReportImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("UserCrimeReportId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("UserCrimeReportId");

                    b.ToTable("UserCrimeReportImages");
                });
            ...
            modelBuilder.Entity("SafetyMapData.Entities.UserCrimeReport", b =>
                {
                    ...
                    b.HasOne("SafetyMapData.Entities.UserIdentity", "UserIdentity")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SafetyMapData.Entities.UserCrimeReportImage", b =>
                {
                    b.HasOne("SafetyMapData.Entities.UserCrimeReport", "UserCrimeReport")
                        .WithMany("Images")
                        .HasForeignKey("UserCrimeReportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("UserCrimeReport");
                });
