...
namespace SafetyMapWeb.Seeding.Seeders
{
    public static class CrimeStatisticSeeder
    {
        public static async Task SeedAsync(IServiceProvider serviceProvider)
        {
            ...
            {
                // Sofia
                Guid.Parse("N1111111-1111-1111-1111-111111111111"),
                Guid.Parse("N1111112-1111-1111-1111-111111111111"),
                Guid.Parse("N1111113-1111-1111-1111-111111111111"),
                Guid.Parse("N1111114-1111-1111-1111-111111111111"),
                // Plovdiv
                Guid.Parse("N2222221-2222-2222-2222-222222222222"),
                Guid.Parse("N2222222-2222-2222-2222-222222222222"),
                Guid.Parse("N2222223-2222-2222-2222-222222222222"),
                Guid.Parse("N2222224-2222-2222-2222-222222222222"),
                // Varna
                Guid.Parse("N3333331-3333-3333-3333-333333333333"),
                Guid.Parse("N3333332-3333-3333-3333-333333333333"),
                Guid.Parse("N3333333-3333-3333-3333-333333333333"),
                Guid.Parse("N3333334-3333-3333-3333-333333333333")
            };
